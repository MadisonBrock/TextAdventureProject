...
// sets the value of the usersInput to the users entry
let userInput = prompt(q1)


// NESTED CONDITIONAL STATEMENT
// 1st conditional statement
// NOTE: Prompts. returns the value entered as a string. That is why double equals == is used instead of triple equals
if (userInput == 1){
    userInput = prompt(q2);
